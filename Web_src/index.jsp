        ...
        <div class="carousel slide">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <a href="event_details.jsp?id=<%=rs.getString("IMAGE")%>"><img src="img/portfolio/<%=rs.getString("IMAGE")%>"></a>
                </div><!--/.item-->
                <%rs.next();%>

                <div class="item">
                <a href="event_details.jsp?id=<%=rs.getString("IMAGE")%>"><img src="img/portfolio/<%=rs.getString("IMAGE")%>" width="100%"></a>
                </div><!--/.item-->
                <%rs.next();%>
                <div class="item">
                 <a href="event_details.jsp?id=<%=rs.getString("IMAGE")%>"><img src="img/portfolio/<%=rs.getString("IMAGE")%>" width="100%"></a>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="calltoaction-wrapper">
							<h3>Welcome to <span style="color:#aec62c;font-size:24px;">EVENTRO</span> ( a college event portal ) </h3> <a href="events.jsp" class="btn btn-orange">Explore Events</a>
						</div>
					</div>
				</div>
			</div>
...
<%        
     ...
     <div class="col-md-4 col-sm-6">
					<figure>
						<img src="img/portfolio/<%=rs.getString("IMAGE")%>" alt="img04">
						<figcaption>
                                                    <h3><%out.print(rs.getString("EVENTNAME"));%></h3>
							<span><%out.print(rs.getString("ORGANISER"));%></span>
                                           
							<a href="event_details.jsp?image=<%=rs.getString("IMAGE")%>">Explore Now</a>
						</figcaption>
					</figure>
	        	</div>
         <% } %>
		    	...
		    	<div class="row">
		    		...
		    		<div class="col-footer col-md-4 col-xs-6">
		    			...
		    			<p class="contact-us-details">
	        				<b>Address:</b> MITS college ,Near Gole Ka MANdir<br/>
		    		...
		    		<div class="col-footer col-md-4 col-xs-6">
						...
						<p>We are at all social networks.</p>
		    			<div>
		    		...
		    		<div class="col-footer col-md-4 col-xs-6">
		    			<h3>About Our Company</h3>
		    				<p>We are a college event portal.</p>
		    		</div>

		    	</div>
		    	<div class="row">
		    		<div class="col-md-12">
		    			<div class="footer-copyright">&copy; 2017 <a href="http://www.vactualart.com/portfolio-item/basica-a-free-html5-template/">Basica</a> Bootstrap HTML Template. By <a href="http://www.vactualart.com">Vactual Art</a>.</div>
		    		</div>
		    	</div>
		    </div>
	    </div>
